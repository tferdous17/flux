...
public class FluxProducerTest {
    ...
    public void testConfigurationValidation() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new RecordAccumulator(0, 3, 100, 30000, 0.9, 32 * 1024 * 1024L, CompressionType.NONE);
        }, "Should throw exception for batch size <= 0");
        
        // Test invalid batch size threshold
        assertThrows(IllegalArgumentException.class, () -> {
            new RecordAccumulator(1024, 3, 100, 30000, 1.5, 32 * 1024 * 1024L, CompressionType.NONE);
        }, "Should throw exception for batch size threshold > 1");
        
        assertThrows(IllegalArgumentException.class, () -> {
            new RecordAccumulator(1024, 3, 100, 30000, -0.1, 32 * 1024 * 1024L, CompressionType.NONE);
    ...
    public void testValidConfigurationValues() {
        ...
        assertDoesNotThrow(() -> {
            RecordAccumulator accumulator = new RecordAccumulator(8192, 3, 200, 15000, 0.8, 16 * 1024 * 1024L, CompressionType.GZIP);
